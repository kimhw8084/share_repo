# Visembler — Visual Report Authoring Production

> R14 current release: 710 Python tests PASS, governance 0/0, functional browser 38/38, visual/layout 44/44, R14 hard browser 134/134, content torture 992/992, frozen authority 27/27, wheel/source parity PASS. See `R14_PRODUCTION_SIGNOFF.md`.

Visembler (Visual + Assembler) is a Company UI-powered NiceGUI application for internal engineering, data, monitoring and RCA report authoring. `3.0.0a1` keeps the certified v2 rendering/design contracts as the compatibility floor while adding governed application runtime, data, workspace, interaction and extension layers above them.
