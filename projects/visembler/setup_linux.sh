...
if [[ ! -d "$VENV" ]]; then
  "$PYTHON" -m venv "$VENV" || { echo "ERROR: Python venv creation failed. Use the approved company Python distribution or install the matching python3-venv package."; exit 1; }
fi
